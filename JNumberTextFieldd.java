...
public class JNumberTextFieldd extends JTextField {
    ...
    public JNumberTextFieldd() {
        this(10,DECIMAL);
    }

    public JNumberTextFieldd(int iMaxLen)
    {
        this(iMaxLen, NUMERIC);
    }

    public JNumberTextFieldd(int iMaxLen, int iFormat)
    {
